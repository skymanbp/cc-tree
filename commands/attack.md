...
argument-hint: "<file_path> [--lang <tag|auto>] [--focus <section|claim|equation>] [--from-prior <report.md>] [--width N|∞] [--depth N|∞] [--rounds N|conv] [--out <dir>] [--glossary <path>] [--field <name|path>] [--no-grill] [--no-online]"
---
