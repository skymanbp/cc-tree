...
<!-- i18n-source-sha256: d204899fab635b49528484f48b4a6469c3818e4ae2bd0b836a35fef7dcfd9cd8 -->
...
- **brainstorm.** "放松：去掉对 Σ_crit 的宇宙学先验约束 → 打开一条
  ...
  新简并。"
- **attack.** "放松：论文的 S/N 判据要求 5σ。在 3σ 下样本大致变成三倍
  ——新进来的那些临界检测是否遵循同一趋势，还是把所声称的相关性冲淡了？
  收紧：在 7σ 下结果增强但样本量减半——5σ 这个选择是不是事后
  （post-hoc）优化出来的？"
...
- **brainstorm.** "亚结构检测当前针对 ~10⁸ M_sun。推到 10¹¹：
  银河系尺度的晕，此时透镜体本身就是一整个星系，重子收缩会重塑其
  密度轮廓。推到 10⁵：暖暗物质截断区间内的子晕——可能是一个 WDM
  约束的角度。"
